...
#if defined(BOOST_IN_MODULE_PURVIEW) && !defined(BOOST_CORE_DETAIL_LWT_UNATTENDED_HPP_INCLUDED)
#  error "Please #include <boost/core/detail/lwt_unattend.hpp> in your module global fragment"
#endif
